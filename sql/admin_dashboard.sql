-- ========== F3: دالة قراءة لوحة القرارات — تقرأ ملخّصات F1 (لا مسح جداول خام) ==========
-- SECURITY DEFINER مبوّبة بـ is_platform_admin(). كل المخرجات من restaurant_stats +
-- platform_daily_metrics (سريعة بأي حجم) + استعلامات صغيرة للتنبيهات (فواتير/اشتراكات).
