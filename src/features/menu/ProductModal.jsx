    ...
    <div style={{ position:'fixed', inset:0, zIndex:100, display:'flex', alignItems:'flex-end', justifyContent:'center' }}>
      ...
      <div style={{
        ...
        >
          ...
          <div style={{ height:'250px', margin:'0 20px', borderRadius:'16px', background: product.image_url ? '#F8F9FB' : `linear-gradient(135deg, ${brandColor}22, ${brandColor}08)`, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'70px', overflow:'hidden' }}>
            {product.image_url
