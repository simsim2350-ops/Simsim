...
export default function EmptyOrders({ brandColor, t, onBack }) {
  return (
    <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', textAlign:'center', padding:'46px 30px 40px' }}>
      ...
      <button
        onClick={onBack}
        style={{ padding:'14px 28px', borderRadius:'14px', border:'none', background:`linear-gradient(135deg, ${brandColor}, ${brandColor}CC)`, color:'white', fontFamily:'Cairo,sans-serif', fontWeight:'800', fontSize:'14px', cursor:'pointer', boxShadow:`0 8px 20px ${brandColor}44` }}
      >
        {t('browseMenu')}
      </button>
    </div>
