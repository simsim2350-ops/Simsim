...
export default class RootErrorBoundary extends Component {
  ...
  render() {
    if (this.state.err) {
      return (
        <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', background:'#0B0B0F', color:'white', gap:'18px', fontFamily:'Tajawal,sans-serif', padding:'24px', textAlign:'center' }}>
