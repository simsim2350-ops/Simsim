...
export default function Settings() {
  ...
  useEffect(() => {
    if (restaurant) {
      ...
      if (Array.isArray(restaurant.opening_hours) && restaurant.opening_hours.length === 7) {
  ...
  // حفظ أوقات عمل المطعم (الفرع الرئيسي) في قاعدة البيانات
          ...
          <div style={{ maxWidth:'600px', margin:'0 auto' }}>
            ...
            {activeTab === 'hours' && (
              <div style={{ background:'white', borderRadius:'16px', border:'1px solid #E5E7EB', overflow:'hidden' }}>
                ...
                <div style={{ padding:'0 16px 8px', fontSize:'11px', color:'#9CA3AF', lineHeight:'1.6' }}>
                  دي أوقات <b>الفرع الرئيسي</b> (المنيو العام). كل فرع ليهو أوقاته الخاصة من صفحة الفروع.
                </div>
