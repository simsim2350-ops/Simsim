                      ...
                      <div style={{ padding:'12px 14px', display:'flex', alignItems:'center', gap:'10px' }}>
                        <div style={{ flex:1, minWidth:0 }}>
                          <div style={{ display:'flex', alignItems:'center', gap:'8px', marginBottom:'4px' }}>
                            ...
                            <span style={{ padding:'2px 8px', borderRadius:'100px', background:s.bg, color:s.color, fontSize:'11px', fontWeight:'700' }}>{s.label}</span>
                          ...
                          <div style={{ fontSize:'12px', color:'#9CA3AF', display:'flex', gap:'8px', flexWrap:'wrap' }}>
                            ...
                            {order.table_number && <span>🪑 طاولة {order.table_number}</span>}
