...
export default function Dashboard() {
  ...
  const Sidebar = () => (
    <aside style={{
      ...
      <nav style={{ padding:'8px 12px', flex:1, overflowY:'auto' }}>
        ...
        <NavItem icon="📋" label="الأقسام" onClick={() => toast('قريباً! 🔧')} />
        <NavItem icon="🍽️" label="الأصناف" onClick={() => toast('قريباً! 🔧')} />
      ...
      <div style={{ padding:'12px', borderTop:'1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ display:'flex', alignItems:'center', gap:'10px', padding:'10px 12px', marginBottom:'8px' }}>
          <div style={{ width:'32px', height:'32px', borderRadius:'50%', background:'linear-gradient(135deg,#667eea,#764ba2)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'13px', fontWeight:'700', color:'white', fontFamily:'Cairo,sans-serif' }}>
        ...
        <button
          ...
          style={{ width:'100%', padding:'9px', borderRadius:'9px', border:'1px solid rgba(239,68,68,0.3)', background:'rgba(239,68,68,0.08)', color:'#FC8181', fontFamily:'Cairo,sans-serif', fontWeight:'700', fontSize:'12px', cursor:'pointer' }}
        >
          تسجيل الخروج 🚪
        </button>
      </div>
  ...
  return (
    <div style={{ display:'flex', height:'100vh', overflow:'hidden', direction:'rtl', position:'relative' }}>
      ...
      {/* Main */}
      <main style={{
        marginRight: window.innerWidth > 768 ? '240px' : '0',
        ...
        <div style={{ height:'56px', background:'white', borderBottom:'1px solid #E5E7EB', display:'flex', alignItems:'center', padding:'0 16px', gap:'10px', flexShrink:0 }}>
          ...
          <button
            ...
            style={{ background:'none', border:'none', fontSize:'22px', cursor:'pointer', padding:'4px', display: window.innerWidth > 768 ? 'none' : 'block' }}
          >
            ☰
          </button>
        ...
        <div style={{ flex:1, overflowY:'auto', padding:'16px' }}>
          ...
          <div style={{ background:'white', borderRadius:'16px', border:'1px solid #E5E7EB', overflow:'hidden', marginBottom:'16px' }}>
            ...
            {orders.length === 0 ? (
              <div style={{ padding:'40px 16px', textAlign:'center', color:'#9CA3AF' }}>
                ...
                <div style={{ fontSize:'14px', marginBottom:'6px' }}>لا توجد طلبات اليوم</div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(2,1fr)', gap:'12px' }}>
            {[
              ...
              <div key={q.label} onClick={() => toast('قريباً! 🔧')} style={{ background:'white', border:'1.5px solid #E5E7EB', borderRadius:'14px', padding:'16px 12px', cursor:'pointer', textAlign:'center' }}>
